"use client";
import { r as u } from "./index--tQcscZa.js";
import { u as pe } from "./index-CJkT59yQ.js";
import { d as z, P as oe, g as ge } from "./index-jG1cqCvV.js";
import { j as ce } from "./jsx-runtime-0-JxQnzY.js";
import { I as ye } from "./index-pvjnvxJ7.js";
var j = 0;
function Et() {
  u.useEffect(() => {
    const e = document.querySelectorAll("[data-radix-focus-guard]");
    return (
      document.body.insertAdjacentElement("afterbegin", e[0] ?? Z()),
      document.body.insertAdjacentElement("beforeend", e[1] ?? Z()),
      j++,
      () => {
        (j === 1 &&
...
var U = "focusScope.autoFocusOnMount",
  ...
  be = "FocusScope",
  Ee = u.forwardRef((e, t) => {
    const { loop: r = !1, trapped: n = !1, onMountAutoFocus: c, onUnmountAutoFocus: i, ...l } = e,
      [a, S] = u.useState(null),
      b = z(c),
      g = z(i),
      f = u.useRef(null),
        ...
        let o = function (p) {
          ...
          d = function (p) {
            if (document.activeElement === document.body)
              for (const E of p) E.removedNodes.length > 0 && A(a);
          };
        ...
        if (a) {
          ...
          if (!a.contains(o)) {
            ...
            (a.addEventListener(U, b),
              a.dispatchEvent(d),
              d.defaultPrevented ||
                (Se(Te(ue(a)), { select: !0 }), document.activeElement === o && A(a)));
          }
          return () => {
            (a.removeEventListener(U, b),
              setTimeout(() => {
                const d = new CustomEvent(_, q);
                (a.addEventListener(_, g),
                  a.dispatchEvent(d),
                  d.defaultPrevented || A(o ?? document.body, { select: !0 }),
                  a.removeEventListener(_, g),
                  $.remove(h));
              }, 0));
          };
        }
    ...
    const w = u.useCallback(
      (o) => {
        ...
        if (s && d) {
          ...
          p && y
            ? !o.shiftKey && d === y
              ? (o.preventDefault(), r && A(p, { select: !0 }))
              : o.shiftKey && d === p && (o.preventDefault(), r && A(y, { select: !0 }))
            : d === m && o.preventDefault();
        }
      },
      [r, n, h.paused],
    );
    return ce.jsx(oe.div, { tabIndex: -1, ...l, ref: v, onKeyDown: w });
  });
Ee.displayName = be;
function Se(e, { select: t = !1 } = {}) {
  const r = document.activeElement;
  for (const n of e) if ((A(n, { select: t }), document.activeElement !== r)) return;
}
function we(e) {
  const t = ue(e),
    r = Q(t, e),
...
function Q(e, t) {
  for (const r of e) if (!Ce(r, { upTo: t })) return r;
}
...
function A(e, { select: t = !1 } = {}) {
  if (e && e.focus) {
    const r = document.activeElement;
    (e.focus({ preventScroll: !0 }), e !== r && Re(e) && t && e.select());
  }
}
var $ = Ae();
function Ae() {
...
var ke = "Portal",
  Pe = u.forwardRef((e, t) => {
    ...
    const l =
      r ||
      (c && ((a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : a.body));
    return l ? ye.createPortal(ce.jsx(oe.div, { ...n, ref: t }), l) : null;
  });
Pe.displayName = ke;
var Ne = function (e) {
    ...
    return (
      ...
      function () {
        (l.forEach(function (f) {
          ...
          (k.set(f, v),
            i.set(f, h),
            v || (F.has(f) || f.removeAttribute(n), F.delete(f)),
            h || f.removeAttribute(r));
        }),
          K--,
          K || ((k = new WeakMap()), (k = new WeakMap()), (F = new WeakMap()), (L = {})));
      }
    );
  },
  St = function (e, t, r) {
...
var We = typeof window < "u" ? u.useLayoutEffect : u.useEffect,
  ee = new WeakMap();
function Be(e, t) {
  var r = Ie(null, function (n) {
...
var fe = Ue(),
  ...
  D = u.forwardRef(function (e, t) {
    var r = u.useRef(null),
      n = u.useState({ onScrollCapture: V, onWheelCapture: V, onTouchMoveCapture: V }),
      c = n[0],
      i = n[1],
      l = e.forwardProps,
      a = e.children,
    ...
    return u.createElement(
      ...
      l
        ? u.cloneElement(u.Children.only(a), C(C({}, R), { ref: T }))
        : u.createElement(m, C({}, R, { className: S, ref: T }), a),
    );
  });
...
var Ye = function () {
  ...
  qe = function (e) {
    if ((e === void 0 && (e = "margin"), typeof window > "u")) return ze;
    var t = Ze(e),
...
`,
  ...
  Je = function () {
    u.useEffect(function () {
      return (
        document.body.setAttribute(M, (te() + 1).toString()),
        function () {
          var e = te() - 1;
  ...
  et = function (e) {
    ...
    return u.createElement(Qe, { styles: $e(i, !t, c, r ? "" : "!important") });
  },
  Y = !1;
if (typeof window < "u")
  try {
...
var P = Y ? { passive: !1 } : !1,
  ...
  ve = function (e, t) {
    ...
    return r[t] !== "hidden" && !(r.overflowY === r.overflowX && !tt(e) && r[t] === "visible");
  },
  rt = function (e) {
  ...
  ut = function (e, t, r, n, c) {
    var i = ct(e, window.getComputedStyle(t).direction),
      l = i * n,
      a = r.target,
      S = t.contains(a),
      b = !1,
...
function ft(e) {
    ...
    u.useEffect(
      function () {
        if (e.inert) {
          ...
          var o = Fe([e.lockRef.current], (e.shards || []).map(ae), !0).filter(Boolean);
          return (
  ...
  var a = u.useCallback(function (o, s) {
      ...
      var d = I(o),
        m = r.current,
        p = "deltaX" in o ? o.deltaX : m[0] - d[0],
        y = "deltaY" in o ? o.deltaY : m[1] - d[1],
        E,
        T = o.target,
        R = Math.abs(p) > Math.abs(y) ? "h" : "v";
      if ("touches" in o && R === "h" && T.type === "range") return !1;
      var O = re(R, T);
      if (!O) return !0;
      if ((O ? (E = R) : ((E = R === "v" ? "h" : "v"), (O = re(R, T))), !O)) return !1;
      if ((!n.current && "changedTouches" in o && (p || y) && (n.current = E), !E)) return !0;
      var G = n.current || E;
      return ut(G, s, o, G === "h" ? p : y);
    }, []),
    S = u.useCallback(function (o) {
      var s = o;
      if (!(!N.length || N[N.length - 1] !== i)) {
        var d = "deltaY" in s ? ne(s) : I(s),
    ...
    b = u.useCallback(function (o, s, d, m) {
      var p = { name: o, delta: s, target: d, should: m, shadowParent: dt(d) };
      (t.current.push(p),
        setTimeout(function () {
    ...
    g = u.useCallback(function (o) {
      ((r.current = I(o)), (n.current = void 0));
    }, []),
...
export { Ee as F, Pe as P, ht as R, St as h, Et as u };
