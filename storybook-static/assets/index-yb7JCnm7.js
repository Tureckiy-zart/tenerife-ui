"use client";
import { r as a } from "./index--tQcscZa.js";
import { u as E } from "./index-CJkT59yQ.js";
import { g as A } from "./index-jG1cqCvV.js";
function T(n, e) {
...
var P = (n) => {
  const { present: e, children: r } = n,
    t = R(e),
    i = typeof r == "function" ? r({ present: t.isPresent }) : a.Children.only(r),
    c = E(t.ref, v(i));
    ...
    A(() => {
      if (e) {
        ...
        const m = e.ownerDocument.defaultView ?? window,
          d = (u) => {
            const M = l(t.current).includes(CSS.escape(u.animationName));
            if (u.target === e && M && (s("ANIMATION_END"), !i.current)) {
...
function v(n) {
  var t, i;
  let e = (t = Object.getOwnPropertyDescriptor(n.props, "ref")) == null ? void 0 : t.get,
    r = e && "isReactWarning" in e && e.isReactWarning;
  return r
    ? n.ref
    : ((e = (i = Object.getOwnPropertyDescriptor(n, "ref")) == null ? void 0 : i.get),
      (r = e && "isReactWarning" in e && e.isReactWarning),
