"use client";
import { r as o } from "./index--tQcscZa.js";
import { d as b, P as w, a as y, h as _ } from "./index-jG1cqCvV.js";
import { u as R } from "./index-CJkT59yQ.js";
import { j as x } from "./jsx-runtime-0-JxQnzY.js";
...
var j = "DismissableLayer",
  ...
  z = "dismissableLayer.pointerDownOutside",
  ...
  M = o.forwardRef((r, e) => {
    const {
      ...
      I = Y((i) => {
        const v = i.target,
          C = [...c.branches].some((h) => h.contains(v));
        !D || C || (t == null || t(i), l == null || l(i), i.defaultPrevented || d == null || d());
      }, f),
      L = q((i) => {
        const v = i.target;
        [...c.branches].some((h) => h.contains(v)) ||
          (a == null || a(i), l == null || l(i), i.defaultPrevented || d == null || d());
      }, f);
    return (
      U((i) => {
        P === c.layers.size - 1 &&
          (n == null || n(i), !i.defaultPrevented && d && (i.preventDefault(), d()));
      }, f),
      o.useEffect(() => {
        if (u)
          return (
            s &&
              (c.layersWithOutsidePointerEventsDisabled.size === 0 &&
                ((O = f.body.style.pointerEvents), (f.body.style.pointerEvents = "none")),
      ...
      x.jsx(w.div, {
        ...E,
        ref: W,
        style: { pointerEvents: N ? (D ? "auto" : "none") : void 0, ...r.style },
        onFocusCapture: y(r.onFocusCapture, L.onFocusCapture),
        onBlurCapture: y(r.onBlurCapture, L.onBlurCapture),
        onPointerDownCapture: y(r.onPointerDownCapture, I.onPointerDownCapture),
      })
    );
  });
M.displayName = j;
...
function q(r, e = globalThis == null ? void 0 : globalThis.document) {
  ...
  return (
    o.useEffect(() => {
      const t = (a) => {
        a.target && !n.current && B(H, s, { originalEvent: a }, { discrete: !1 });
      };
...
function B(r, e, s, { discrete: n }) {
  const t = s.originalEvent.target,
    a = new CustomEvent(r, { bubbles: !1, cancelable: !0, detail: s });
