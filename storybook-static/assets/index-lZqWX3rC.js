"use client";
import { c as kn } from "./index--tQcscZa.js";
var Je = { exports: {} };
(function (n, a) {
  (function (o, i) {
    i(a);
    ...
    function W(e) {
      var t, r;
      return (r = (t = $.exec(e)) === null || t === void 0 ? void 0 : t[0]) !== null && r !== void 0
        ? r
        : null;
    }
    const X = (e) => {
    ...
    const H = J({
      ...
      Ct = J({
        ...
        accept: (e, t) => (e === "?" && Ie(t)) || e === "null" || e === "undefined" || e === "*",
        parsePrefix: (e) => {
        ...
        parseInfix: (e, t) => {
          ...
          if (e.consume("infer")) {
            ...
            if (y.type !== "JsdocTypeName")
              throw new d(y, "A typescript asserts always has to have a name on the left side.");
            s.push(y);
          } else
      ...
      return J({
        ...
        parsePrefix: (r) => {
          ...
          if (r.consume("StringValue"))
            ...
            let x = "";
            const k = ["Identifier", "@", "/"];
            for (; k.some((S) => r.consume(S)); ) ((x += y.text), (y = r.lexer.current));
            c = {
              type: "JsdocTypeSpecialNamePath",
              value: x,
              specialType: s,
        ...
        parsePrefix: (r) => {
          ...
          if (!r.consume("}")) {
            ...
            for (;;) {
              ...
              (r.acceptLexerState(y), T === void 0 && t && (T = r.parseIntermediateType(m.OBJECT)));
              let g = !1;
              if (
    ...
    function fe({ allowOptional: e, allowVariadic: t }) {
      return J({
        ...
        parseInfix: (r, s) => {
          ...
          return { type: "JsdocTypeKeyValue", key: s.value, right: T, optional: c, variadic: y };
        },
      });
    }
    const Le = [
        ...
        _e,
        Fe,
        Z({ allowSquareBracketsOnAnyType: !1, allowJsdocNamePaths: !0, pathGrammar: U }),
      ],
      Ht = [
        ...Le,
        de({
      ...
      zt = [
        A({ allowedAdditionalTokens: ["typeof", "module", "keyof", "event", "external", "in"] }),
        ce,
        H,
        D,
        z,
      ...
      en = J({
        ...
        parsePrefix: (e) => {
          ...
          return e.consume("is")
            ? { type: "JsdocTypeAsserts", left: t, right: P(e.parseIntermediateType(m.INFIX)) }
    ...
    const nn = J({
      ...
      ln = J({
        ...
        parseInfix: (e, t) => {
          ...
          return (
            e.consume("is"),
            { type: "JsdocTypePredicate", left: t, right: P(e.parseIntermediateType(m.INFIX)) }
          );
        },
      }),
      pn = J({
        ...
        parsePrefix: (e) => {
          ...
          if (e.consume(":")) {
            ...
            const s = e.baseParser;
            (s.acceptLexerState(e),
              (r = { type: "JsdocTypeMappedType", key: t, right: s.parseType(m.ARRAY_BRACKETS) }),
              e.acceptLexerState(s));
      ...
      un = J({
        ...
        parsePrefix: (e) => (
          e.consume("readonly"),
          { type: "JsdocTypeReadonlyArray", element: Bt(e.parseIntermediateType(m.ALL)) }
        ),
      }),
      yn = J({
      ...
      mn = [
        ...
        on,
        sn,
        Z({ allowSquareBracketsOnAnyType: !0, allowJsdocNamePaths: !1, pathGrammar: U }),
        cn,
        ln,
    ...
    function $e() {
      return {
        ...
        JsdocTypeVariadic: (e, t) =>
          e.meta.position === void 0 ? "..." : te(e.meta.position, t(e.element), "..."),
...
`
    ...
    function En() {
      return {
        ...
        JsdocTypeAssertsPlain: (e, t) => ({ type: "JsdocTypeAssertsPlain", element: t(e.element) }),
        JsdocTypeConditional: (e, t) => ({
          type: "JsdocTypeConditional",
    ...
    switch ((typeof o < "u" && (i.raw = o), n.name)) {
      ...
      case "union":
        return (p = n.elements) != null && p.every(On)
          ? { ...i, name: "enum", value: (u = n.elements) == null ? void 0 : u.map(An) }
          : { ...i, name: a, value: (d = n.elements) == null ? void 0 : d.map(C) };
      case "intersection":
        return { ...i, name: a, value: (f = n.elements) == null ? void 0 : f.map(C) };
      default:
...
const { UnknownArgTypesError: Ln } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var jn = l((n) => {
    switch (n.type) {
      case "function":
        return { name: "function" };
        ...
        return (
          (p = n.elements) != null && p.every((v) => v.name === "literal")
            ? (h = {
                ...i,
                name: "enum",
                value: (u = n.elements) == null ? void 0 : u.map((v) => Ce(v.value)),
              })
            : (h = { ...i, name: a, value: (d = n.elements) == null ? void 0 : d.map(Y) }),
          h
        );
      case "intersection":
...
function et({ fence: n = "```" } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let d of i)
      (Kn.test(d.tokens.description) && !u ? p.push([d]) : p[p.length - 1].push(d),
...
l(ft, "parse");
var Yn = { tags: ["param", "arg", "argument", "returns", "ignore", "deprecated"] },
  Gn = l((n, a = Yn) => {
...
var Qn = l((n, a) => {
  ...
  return { name: n, type: At(a), required: i, description: o, defaultValue: Ot(a) };
}, "createTsPropDef");
function It(n) {
...
function Oe(n, a, o) {
  ...
  return { name: n, type: It(a), required: p, description: i, defaultValue: Ft(u, a) };
}
...
var lr = l((n) => {
  ...
  sr = ((n) => ((n.AUTO = "auto"), (n.CODE = "code"), (n.DYNAMIC = "dynamic"), n))(sr || {});
export {
  xe as B,
  Ge as Y,
  Pt as a,
