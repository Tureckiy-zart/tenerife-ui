...
function l(t, e, r, n, u) {
  ...
  var p = n === "" ? "." : n + ":";
  if (g(t))
    for (var c = 0; c < t.length; c++) ((n = t[c]), (s = p + y(n, c)), (f += l(n, e, r, s, u)));
...
o.createElement = function (t, e, r) {
  ...
  if (e != null)
    for (n in (e.key !== void 0 && (s = "" + e.key), e))
      b.call(e, n) && n !== "key" && n !== "__self" && n !== "__source" && (u[n] = e[n]);
...
o.isValidElement = d;
o.lazy = function (t) {
  return { $$typeof: O, _payload: { _status: -1, _result: t }, _init: Z };
};
o.memo = function (t, e) {
  return { $$typeof: G, type: t, compare: e === void 0 ? null : e };
};
o.startTransition = function (t) {
  ...
  try {
    var n = t(),
      u = i.S;
    (u !== null && u(r, n),
      typeof n == "object" && n !== null && typeof n.then == "function" && n.then(E, w));
  } catch (s) {
    w(s);
  } finally {
...
export { V as R, tt as a, F as c, Y as g, $ as r };
