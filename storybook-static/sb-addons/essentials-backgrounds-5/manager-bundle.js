              ...
              function (r, i, d) {
                ...
                i.exports = function (c) {
                  ...
                  return function (y) {
                    var m = function () {
                      ...
                      for (A = 0; A < v; A++) {
                        if (((P[A] = { cacheItem: b, arg: arguments[A] }), b.has(arguments[A]))) {
                          b = b.get(arguments[A]);
                          continue;
                        }
                      ...
                      return (
                        ...
                        O || ((R = y.apply(null, arguments)), b.set(arguments[v], R)),
                        c > 0 &&
                          ((P[v] = { cacheItem: b, arg: arguments[v] }),
                          O ? t(l, P) : l.push(P),
                ...
                function n(c) {
                  ...
                  for (
                    ...
                    m >= 0 && ((l = c[m]), (y = l.cacheItem.get(l.arg)), !y || !y.size);
                    m--
                  )
                    ...
                    g.createElement(F, {
                      links: [
                        ...
                        ...Object.entries(d).map(([l, y]) => ({
                          id: l,
                          title: y.name,
                          icon: g.createElement(Z, { color: y?.value || "grey" }),
                          active: l === s,
                          onClick: () => {
                            (c({ value: l, grid: n }), I());
                          },
      ...
      N.add(ne, {
        ...
        render: () =>
          FEATURES?.backgroundsStoryGlobals
            ...
            : g.createElement(D, null, g.createElement(ye, null), g.createElement(ke, null)),
      });
    });
  })();
} catch (e) {
