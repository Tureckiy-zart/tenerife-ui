        ...
        <CardContent className="p-md">
          ...
          <div className="border-t border-border pt-sm">
            {ticketUrl && (
              <Link
                href={ticketUrl}
                className="shadow-elevation-md hover:shadow-elevation-lg inline-flex w-full transform items-center justify-center bg-gradient-to-r from-accent-500 to-primary-600 px-md py-xs font-semibold text-white transition-[transform,box-shadow,background-color] duration-normal hover:scale-105 hover:from-accent-600 hover:to-primary-700"
                target="_blank"
