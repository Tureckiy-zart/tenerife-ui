...
export const tailwindTypographyConfig = {
  ...
  fontSize: {
    xs: [fontSize.xs[0], { lineHeight: fontSize.xs[1].lineHeight, letterSpacing: fontSize.xs[1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    sm: [fontSize.sm[0], { lineHeight: fontSize.sm[1].lineHeight, letterSpacing: fontSize.sm[1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    base: [fontSize.base[0], { lineHeight: fontSize.base[1].lineHeight, letterSpacing: fontSize.base[1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    lg: [fontSize.lg[0], { lineHeight: fontSize.lg[1].lineHeight, letterSpacing: fontSize.lg[1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    xl: [fontSize.xl[0], { lineHeight: fontSize.xl[1].lineHeight, letterSpacing: fontSize.xl[1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    "2xl": [fontSize["2xl"][0], { lineHeight: fontSize["2xl"][1].lineHeight, letterSpacing: fontSize["2xl"][1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    "3xl": [fontSize["3xl"][0], { lineHeight: fontSize["3xl"][1].lineHeight, letterSpacing: fontSize["3xl"][1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    "4xl": [fontSize["4xl"][0], { lineHeight: fontSize["4xl"][1].lineHeight, letterSpacing: fontSize["4xl"][1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    "5xl": [fontSize["5xl"][0], { lineHeight: fontSize["5xl"][1].lineHeight, letterSpacing: fontSize["5xl"][1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    "6xl": [fontSize["6xl"][0], { lineHeight: fontSize["6xl"][1].lineHeight, letterSpacing: fontSize["6xl"][1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    "7xl": [fontSize["7xl"][0], { lineHeight: fontSize["7xl"][1].lineHeight, letterSpacing: fontSize["7xl"][1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    "8xl": [fontSize["8xl"][0], { lineHeight: fontSize["8xl"][1].lineHeight, letterSpacing: fontSize["8xl"][1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
    "9xl": [fontSize["9xl"][0], { lineHeight: fontSize["9xl"][1].lineHeight, letterSpacing: fontSize["9xl"][1].letterSpacing }] as [string, { lineHeight: string; letterSpacing: string }],
  },
